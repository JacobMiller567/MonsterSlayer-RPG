/*
if (!(item_array[item_position][item_type] == item_none) and item_position == 0)
    {
    item_position = 0;	
...
//	if (position_meeting(mouse_x, mouse_y, id)) {
    ...
    if (item_array[item_position][item_amount] < 1)
		...
		show_debug_message("Array Slot 0 is empty");
	}
*/
var canUse = true;
if ((item_array[0][item_amount]) > 0)
{
	item_position = 0;
    var _type = item_array[item_position][item_type];
    var _sprite = item_array[item_position][item_sprite];
	...
	if ((item_array[item_position][item_amount]) > 0 and canUse) {
		item_array[item_position][item_amount] += -1;
	}
    var _inst = instance_create_layer(mouse_x, mouse_y, "Manage", Item_Types);
...
//	if (position_meeting(mouse_x, mouse_y, id)) {
    ...
    if (item_array[item_position][item_amount] < 1 and canUse)
        {
        item_array[item_position][item_type] = item_none;
        }
